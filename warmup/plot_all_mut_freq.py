...
paths = {
    ...
    50000: ('/home/laukeller/BSc Thesis/TreeMHN/Example/trees_50000.csv', '/home/laukeller/BSc Thesis/pMHN/src/pmhn/_trees/trees_50000.csv'),
}
...
for i, (num_trees, (r_path, python_path)) in enumerate(paths.items()):
    ...
    r_mutation_frequencies.plot(kind='bar', width=bar_width, position=0, align='center', color='b', alpha=0.5, label='R Trees', ax=axs[i])
    python_mutation_frequencies.plot(kind='bar', width=bar_width, position=1, align='center', color='r', alpha=0.5, label='Python Trees', ax=axs[i])
